...
private:
  ...
  static Event DecodeLOGIN_RESPONSE(const uint8_t *, uint32_t, uint8_t,
                                    uint8_t);
  static Event DecodeSIGNUP_REQUEST(const uint8_t *, uint32_t, uint8_t,
                                    uint8_t);
  static Event DecodeSIGNUP_RESPONSE(const uint8_t *, uint32_t, uint8_t,
                                     uint8_t);
  static Event DecodeLOGOUT(const uint8_t *, uint32_t, uint8_t, uint8_t);
  static Event DecodeLOBBY_LIST_REQUEST(const uint8_t *, uint32_t, uint8_t,
                                        uint8_t);
  static Event DecodeLOBBY_LIST_RESPONSE(const uint8_t *, uint32_t, uint8_t,
                                         uint8_t);
  ...
  static Event DecodePLAYER_END_LOADING(const uint8_t *, uint32_t, uint8_t,
                                        uint8_t);
  ...
  static Event DecodePLAYER_DISCONNECT(const uint8_t *, uint32_t, uint8_t,
                                       uint8_t);
  ...
  static Event DecodeENTITY_DESTROY(const uint8_t *, uint32_t, uint8_t,
                                    uint8_t);
  static Event DecodePLAYER_HIT(const uint8_t *, uint32_t, uint8_t, uint8_t);
  static Event DecodePOWERUP_COLLECTED(const uint8_t *, uint32_t, uint8_t,
                                       uint8_t);
  ...
  static Event DecodeSCROLLING_UPDATE(const uint8_t *, uint32_t, uint8_t,
                                      uint8_t);
  ...
  static Event DecodeCHUNK_TILE_UPDATE(const uint8_t *, uint32_t, uint8_t,
                                       uint8_t);
  static Event DecodeCHUNK_VISIBILITY(const uint8_t *, uint32_t, uint8_t,
                                      uint8_t);
};
