...
SceneManager::SceneManager(GameEngine* engine)
    : m_engine(engine), m_currentScene(nullptr), m_nextScene(nullptr) {}

SceneManager::~SceneManager() { ClearAllScenes(); }

bool SceneManager::LoadSceneModule(const std::string& name,
