...
public:
    ...
    static TileMap generateLevel(int levelIndex, uint16_t screenWidth = 800, uint16_t screenHeight = 600) {
        TileMap map;
        ...
        map.scrollSpeed = 50.0f + (levelIndex * 10.0f);  // Plus rapide à chaque niveau
