...
- [Client setup CMakeLists.txt](Client/CMakeLists.txt)
...
# Download CPM.cmake for Client
cd Client
mkdir -p cmake
wget -O cmake/CPM.cmake https://github.com/cpm-cmake/CPM.cmake/releases/latest/download/get_cpm.cmake

# Download CPM.cmake for Client/src
cd src
mkdir -p cmake
wget -O cmake/CPM.cmake https://github.com/cpm-cmake/CPM.cmake/releases/latest/download/get_cpm.cmake
cd ../..

# Download CPM.cmake for EngineModule
cd EngineModule
mkdir -p cmake
wget -O cmake/CPM.cmake https://github.com/cpm-cmake/CPM.cmake/releases/latest/download/get_cpm.cmake
cd ..

# Download CPM.cmake for Server
cd Server
mkdir -p cmake
wget -O cmake/CPM.cmake https://github.com/cpm-cmake/CPM.cmake/releases/latest/download/get_cpm.cmake

# Download CPM.cmake for Server/src
cd src
mkdir -p cmake
wget -O cmake/CPM.cmake https://github.com/cpm-cmake/CPM.cmake/releases/latest/download/get_cpm.cmake
cd ../..
...
- **[Engine Development Documentation](documentation/ENGINE_DEV_DOC.md)** - Game engine architecture and development guide
- **[Server Technical Documentation](documentation/SERVER_TECHNICAL_DOC.md)** - Complete server architecture, networking
- **[Server Network Contribution Guide](documentation/How-To-Contribute-Network-Server.md)** - How to contribute to server network implementation
- **[Gameplay Guide](documentation/HowToContibute.md)** - Detailed programming proccess for GamePlay contribution
